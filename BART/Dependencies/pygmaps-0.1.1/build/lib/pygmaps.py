...
class maps:
	...
	def draw(self, htmlfile):
		...
		f.write('\t}\n')
		f.write('function timer(){\n')
		f.write('\tsetInterval(function() { initialize(); },1000);\n')
		f.write('}\n')
		f.write('</script>\n')
		f.write('</head>\n')
		f.write('<body style="margin:0px; padding:0px;" onload="timer()">\n')
	...
	#############################################
	def drawmap(self, f):
		f.write('\t\tvar centerlatlng = new google.maps.LatLng(%.4f, %.4f);\n' % (self.center[0],self.center[1]))
	...
	def drawpoint(self,f,lat,lon,color):
		f.write('\t\tvar latlng = new google.maps.LatLng(%.4f, %.4f);\n'%(lat,lon))
	...
	def drawPolyline(self,f,path,\
		...
		for coordinate in path:
			f.write('new google.maps.LatLng(%.4f, %.4f),\n' % (coordinate[0],coordinate[1]))
		f.write('];\n')
		f.write('\n')
